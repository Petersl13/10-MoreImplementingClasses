...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.origional_start = self.start.clone()
        self.origional_end = self.end.clone()
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        temp1 = self.start.plus(other_line.start)
        temp2 = self.end.plus(other_line.end)
    ...
    def line_minus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        a = self.start.minus(other_line.start)
        b = self. end.minus(other_line.end)
    ...
    def reset(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        self.start = self.origional_start
        self.end = self.origional_end
